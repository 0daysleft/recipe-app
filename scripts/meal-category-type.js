...
document.querySelector('.navigate').innerHTML = `<h1> <a href="../index.html">Home</a>/ <a href="../html-files/meal-categories.htm">Categories</a> / ${sessionStorage.getItem('categoryName')} </h1>`
