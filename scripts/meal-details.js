...
function showMealDetails(){
     ...
     `
          <div class='navigation' ><h1><a href="./index.html"><h1>Home</h1></a><a href="./html-files/meal-categories.htm"><h1>${singleMealData.meals[0].strCategory}</h1></a>${singleMealData.meals[0].strMeal}</h1></div>
